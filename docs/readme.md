# Requiems API documentation

Documentation for the platform: backend services, workers, dashboard,
infrastructure, and API reference material maintained alongside the code.
...
| **Design plans** | Dated specs and implementation notes for larger features                         | [design-plans/](./design-plans/)    |
