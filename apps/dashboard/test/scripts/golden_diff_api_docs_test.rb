...
class GoldenDiffApiDocsTest < ActiveSupport::TestCase
  test "compare_curls matches equivalent query, JSON, and multiline formatting" do
    generated = <<~CURL
      curl -X POST "https://requiems.xyz/v1/test?b=two&a=one" \
        -H "Content-Type: application/json" \
        -H "requiems-api-key: YOUR_API_KEY" \
        -d '{"a":1,"nested":{"enabled":true}}'
    CURL
    handwritten = <<~CURL
      curl -X POST 'https://requiems.xyz/v1/test?a=one&b=two' \
        -H 'requiems-api-key: YOUR_API_KEY' \
        -H 'Content-Type: application/json' \
  ...
  test "compare_curls reports structural mismatches for manual override" do
    generated = 'curl -X POST "https://requiems.xyz/v1/test" -d \'{"value":1}\''
    handwritten = 'curl -X PUT "https://requiems.xyz/v1/test" -d \'{"value":1}\''
  ...
  test "compare_curls reports unparseable snippets for needs review" do
    generated = "curl"
    handwritten = 'curl "https://requiems.xyz/v1/test"'
