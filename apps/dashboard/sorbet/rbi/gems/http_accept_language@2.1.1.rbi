...
# pkg:gem/http_accept_language#lib/http_accept_language/auto_locale.rb:3
module HttpAcceptLanguage; end

# pkg:gem/http_accept_language#lib/http_accept_language/auto_locale.rb:4
module HttpAcceptLanguage::AutoLocale
  extend ::ActiveSupport::Concern

  private

  # pkg:gem/http_accept_language#lib/http_accept_language/auto_locale.rb:17
  def set_locale; end
end

# pkg:gem/http_accept_language#lib/http_accept_language/railtie.rb:12
module HttpAcceptLanguage::EasyAccess
  # pkg:gem/http_accept_language#lib/http_accept_language/railtie.rb:13
  def http_accept_language; end
end

# pkg:gem/http_accept_language#lib/http_accept_language/middleware.rb:2
class HttpAcceptLanguage::Middleware
  # pkg:gem/http_accept_language#lib/http_accept_language/middleware.rb:3
  def initialize(app); end

  # pkg:gem/http_accept_language#lib/http_accept_language/middleware.rb:7
  def call(env); end
end

# pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:2
class HttpAcceptLanguage::Parser
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:5
  ...
  #
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:61
  def compatible_language_from(available_languages); end

  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:3
  def header; end
  ...
  #
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:94
  ...
  #   # => 'nl'
  #
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:50
  ...
  #
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:79
  ...
  #
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:17
  def user_preferred_languages; end

  # Sets the user languages preference, overriding the browser
  #
  # pkg:gem/http_accept_language#lib/http_accept_language/parser.rb:39
  def user_preferred_languages=(languages); end
end

# pkg:gem/http_accept_language#lib/http_accept_language/railtie.rb:2
