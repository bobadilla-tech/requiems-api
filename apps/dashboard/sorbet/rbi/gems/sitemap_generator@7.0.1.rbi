...
module SitemapGenerator
  class << self
    # pkg:gem/sitemap_generator#lib/sitemap_generator.rb:60
    def app; end
    ...
    #
    # pkg:gem/sitemap_generator#lib/sitemap_generator.rb:66
    def verbose; end

    # Global default for the verbose setting.
    #
    # pkg:gem/sitemap_generator#lib/sitemap_generator.rb:61
    ...
    #
    # pkg:gem/sitemap_generator#lib/sitemap_generator.rb:82
    def yield_sitemap?; end
  end
end

# pkg:gem/sitemap_generator#lib/sitemap_generator/application.rb:6
class SitemapGenerator::Application
  # Returns a boolean indicating whether this environment is Rails 3
  #
  # @return [Boolean]
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/application.rb:14
  def is_at_least_rails3?; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/application.rb:7
  def is_rails?; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/application.rb:20
  def root; end
  ...
  # @return [String, nil]
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/application.rb:43
  def rails_env; end
  ...
  # @return [String, nil]
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/application.rb:31
  def rails_root; end
end

# Define our own class rather than modify the global class
#
# pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:13
class SitemapGenerator::BigDecimal
  ...
  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:44
  def encode_with(coder); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:49
  def to_d; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:54
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:35
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:15
SitemapGenerator::BigDecimal::YAML_MAPPING = T.let(T.unsafe(nil), Hash)

# pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/big_decimal.rb:14
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/builder.rb:9
...
#
# pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:16
class SitemapGenerator::Builder::SitemapFile
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:25
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:94
  def add(link, options = T.unsafe(nil)); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:63
  def empty?; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:70
  def file_can_fit?(bytes); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:18
  def filesize; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:122
  def finalize!; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:128
  def finalized?; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:57
  def lastmod; end
  ...
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:173
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:167
  def new; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:156
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:139
  def write; end

  # Return true if this file has been written out to disk
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_file.rb:150
  def written?; end
end

# pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:5
class SitemapGenerator::Builder::SitemapIndexFile < ::SitemapGenerator::Builder::SitemapFile
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:11
  def initialize(opts = T.unsafe(nil)); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:50
  def add(link, options = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:121
  ...
  # bytesize will be calculated for you.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:89
  def file_can_fit?(bytes); end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:129
  def index_url; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:99
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:49
  def super_add(link, options = T.unsafe(nil)); end

  # Return the total number of links in all sitemaps reference by this index file
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:95
  def total_link_count; end

  # Write out the index if an index is needed
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:113
  def write; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_file.rb:140
  def write_first_sitemap; end
end

# pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_url.rb:7
class SitemapGenerator::Builder::SitemapIndexUrl < ::SitemapGenerator::Builder::SitemapUrl
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_index_url.rb:20
...
class SitemapGenerator::Builder::SitemapUrl < ::Hash
  ...
  # * +pagemap+
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:34
  def initialize(path, options = T.unsafe(nil)); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:181
  def news?; end

  # Return the URL as XML
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:88
  def to_xml(builder = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:258
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:201
  def prepare_images(images, host); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:195
  def prepare_news(news); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:187
  def prepare_video_price_attribs(video); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:210
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:240
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/builder/sitemap_url.rb:252
...
class SitemapGenerator::FileAdapter
  ...
  # to compress it.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/adapters/file_adapter.rb:32
  def gzip(stream, data); end

  # Write `data` to a stream as is.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/adapters/file_adapter.rb:39
...
#
# pkg:gem/sitemap_generator#lib/sitemap_generator/helpers/number_helper.rb:16
module SitemapGenerator::Helpers::NumberHelper
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/helpers/number_helper.rb:182
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/helpers/number_helper.rb:150
SitemapGenerator::Helpers::NumberHelper::DECIMAL_UNITS = T.let(T.unsafe(nil), Hash)

# Raised when argument +number+ param given to the helpers is invalid and
# the option :raise is set to  +true+.
#
# pkg:gem/sitemap_generator#lib/sitemap_generator/helpers/number_helper.rb:20
class SitemapGenerator::Helpers::NumberHelper::InvalidNumberError < ::StandardError
  # pkg:gem/sitemap_generator#lib/sitemap_generator/helpers/number_helper.rb:22
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/helpers/number_helper.rb:149
...
#
# pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:9
class SitemapGenerator::Interpreter
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:27
  def initialize(opts = T.unsafe(nil), &block); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:34
  def add(*args); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:38
  def add_to_index(*args); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:13
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:58
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:46
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:52
  def sitemap; end
  ...
  class << self
    ...
    #
    # pkg:gem/sitemap_generator#lib/sitemap_generator/interpreter.rb:75
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:8
class SitemapGenerator::LinkSet
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:122
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:149
  def add(link, options = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:166
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:35
  ...
  # +default_host+.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:197
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:281
  ...
  # option to rake to turn verbose off.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:14
  def verbose=(_arg0); end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:376
  def yield_sitemap?; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:438
  ...
  # sitemap.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:459
  def finalize_sitemap!; end

  # Finalize a sitemap index and output a summary line.  Do nothing if it has already
  # been finalized.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:472
  def finalize_sitemap_index!; end

  # Return the interpreter linked to this instance.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:480
  def interpreter; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:402
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:496
  def output(string); end

  # Reset this instance.  Keep the same options, but return to the same state
  # as before any sitemaps were created.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:487
  def reset!; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:387
...
module SitemapGenerator::LinkSet::LocationHelpers
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:656
  def compress; end
  ...
  # groups, pass in a `:compress` option e.g. <tt>group(:compress => false) { add('/link') }</tt>
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:648
  ...
  # one sitemap file.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:615
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:508
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:560
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:634
  def namer; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:625
  def namer=(value); end

  # Return a Pathname with the full path to the public directory
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:530
  def public_path; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:520
  def public_path=(value); end

  # Return the hash of search engines.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:575
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:548
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:537
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/link_set.rb:664
  def update_location_info(attribute, value, opts = T.unsafe(nil)); end
end

# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:29
SitemapGenerator::MAX_SITEMAP_FILES = T.let(T.unsafe(nil), Integer)

# max news sitemap per index_file
#
# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:33
...
#
# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:30
SitemapGenerator::MAX_SITEMAP_LINKS = T.let(T.unsafe(nil), Integer)

# max images per url
#
# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:32
SitemapGenerator::MAX_SITEMAP_NEWS = T.let(T.unsafe(nil), Integer)

# pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:3
class SitemapGenerator::Numeric
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:16
  def bytes; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:49
  def exabyte; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:46
  def exabytes; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:34
  def gigabyte; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:31
  def gigabytes; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:24
  def kilobyte; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:21
  def kilobytes; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:29
  def megabyte; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:26
  def megabytes; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:44
  def petabyte; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:41
  def petabytes; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:39
  def terabyte; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:36
  def terabytes; end
end
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:4
SitemapGenerator::Numeric::KILOBYTE = T.let(T.unsafe(nil), Integer)

# pkg:gem/sitemap_generator#lib/sitemap_generator/core_ext/numeric.rb:5
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/railtie.rb:4
class SitemapGenerator::Railtie < ::Rails::Railtie; end

# bytes
#
# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:34
...
class SitemapGenerator::SimpleNamer
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/simple_namer.rb:57
  def next; end

  # Return this instance set to the previous name
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/simple_namer.rb:67
  def previous; end

  # Reset to the first name
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/simple_namer.rb:47
  def reset; end

  # True if on the first name
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/simple_namer.rb:52
  def start?; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/simple_namer.rb:41
  def to_s; end
end

# Lazy-initialize the LinkSet instance
#
# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:43
SitemapGenerator::Sitemap = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:23
...
# pkg:gem/sitemap_generator#lib/sitemap_generator.rb:24
class SitemapGenerator::SitemapFullError < ::SitemapGenerator::SitemapError; end

# pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:183
class SitemapGenerator::SitemapIndexLocation < ::SitemapGenerator::SitemapLocation
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:184
  def initialize(opts = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:196
  def create_index; end

  # Return a summary string
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:201
...
class SitemapGenerator::SitemapLocation < ::Hash
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:155
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:84
  def directory; end
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:104
  def filesize; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:15
  def host; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:146
  def namer; end

  # Full path of the file including the filename.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:89
  def path; end

  # Relative path of the file (including the filename) relative to <tt>public_path</tt>
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:94
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:132
  def reserve_name; end

  # Return true if this location has a fixed filename.  If no name has been
  # reserved from the namer, for instance, returns false.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:142
  def reserved_name?; end
  ...
  # Return a summary string
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:175
  def summary(link_count); end

  # Full URL of the file.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:99
  def url; end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:150
  def verbose?; end

  # Return a new Location instance with the given options merged in
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:79
  def with(opts = T.unsafe(nil)); end

  # Write `data` out to a file.
  # Output a summary line if verbose is true.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/sitemap_location.rb:169
...
class SitemapGenerator::Templates
  # pkg:gem/sitemap_generator#lib/sitemap_generator/templates.rb:26
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/templates.rb:33
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/templates.rb:40
...
# pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:4
module SitemapGenerator::Utilities
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:160
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:56
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:34
  ...
  #   if !address.blank?
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:116
  def blank?(object); end

  # Return the bytesize length of the string.  Ruby 1.8.6 compatible.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:180
  def bytesize(string); end

  # Clean sitemap files in output directory.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:27
  def clean_files; end

  # Replace the last 3 characters of string with ... if the string is as big
  # or bigger than max.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:171
  def ellipsis(string, max); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:154
  def falsy?(value); end

  # Copy templates/sitemap.rb to config if not there yet.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:8
  def install_sitemap_rb(verbose = T.unsafe(nil)); end

  # An object is present if it's not blank.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:132
  ...
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:96
  def reverse_merge(hash, other_hash); end

  # Performs the opposite of <tt>merge</tt>, with the keys and values from the first hash taking precedence over the second.
  # Modifies the receiver in place.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:102
  def reverse_merge!(hash, other_hash); end
  ...
  #   x.round(2) # => 1.34
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:72
  def round(float, precision = T.unsafe(nil)); end

  # Return a new hash with all keys converted to symbols, as long as
  # they respond to +to_sym+.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:41
  def symbolize_keys(hash); end

  # Destructively convert all keys to symbols, as long as they respond
  # to +to_sym+.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:47
  def symbolize_keys!(hash); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:144
  def titleize(string); end

  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:150
  def truthy?(value); end

  # Remove config/sitemap.rb if exists.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:20
  def uninstall_sitemap_rb; end

  # Sets $VERBOSE for the duration of the block and back to its original value afterwards.
  #
  # pkg:gem/sitemap_generator#lib/sitemap_generator/utilities.rb:137
