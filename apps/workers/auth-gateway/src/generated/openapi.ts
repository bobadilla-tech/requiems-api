...
export const openApiSpec = {
  ...
  "tags": [
    ...
    },
    {
      "name": "data-integrity",
      "description":
        "Validate, moderate, and normalize user input at the boundary of your product. Stop bad data before it enters your database or downstream services.",
    },
    {
    ...
    },
    {
      ...
      "description":
        "Common developer tools available on the same API key as your production systems. QR codes, Base64 encoding, Markdown rendering, and more.",
    },
    {
      "name": "dictionary",
      "description":
    ...
    },
    {
      "name": "global-data",
      "description":
        "Resolve addresses, coordinates, and IPs into complete location profiles. Timezone, UTC offset, public holidays, and working day counts included in every response.",
    },
    {
      "name": "holidays",
    ...
    },
    {
      "name": "identity-risk",
      "description":
        "Compose email, phone, IP, and behavioral signals into a single risk decision. One call returns whether a user is real, safe, and trustworthy.",
    },
    {
      "name": "inflation",
      "description":
    ...
    },
    {
      ...
      "description":
        "Validate financial identifiers and score transaction risk in a single call. Combines BIN lookup, IBAN parsing, SWIFT verification, and IP intelligence.",
    },
    {
  ...
  "paths": {
    ...
    "/v1/technology/barcode/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "Array of barcode generation requests. Min: 1, Max: 20.",
                  },
                },
                "required": [
                  "items",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "List of barcode generation results preserving input order",
                        },
                        "results[].image": {
                          "type": "string",
                        ...
                        "results[].success": {
                          "type": "boolean",
                          "description": "Whether barcode generation succeeded",
                        },
                        "results[].error": {
                          "type": "string",
          ...
          "422": {
            "description":
              "Valid request body that fails validation (empty items array, more than 20 items, missing data field, or unsupported barcode type).",
          },
          "500": {
    ...
    "/v1/technology/base64/encode": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "variant": {
                    "type": "string",
                    "description":
                      "Encoding variant: standard (default) or url (URL-safe base64url, RFC 4648 §5)",
                    "example": "standard",
                  },
                },
                "required": [
        ...
        "responses": {
          ...
          "400": {
            "description": "value field is missing or empty",
          },
          "401": {
            "description": "Missing or invalid API key",
          },
          "422": {
            "description": "variant is not standard or url",
          },
        },
      },
    },
    ...
    "/v1/technology/base64/encode/batch": {
      "post": {
    ...
    "/v1/technology/base64/decode/batch": {
      "post": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "luhn_prefix_valid": {
                          "type": "boolean",
                          "description":
                            "Whether the BIN prefix (not a full card number) passes the Luhn algorithm check",
                        },
                        "confidence": {
                          "type": "number",
                          "description":
    ...
    "/v1/systems/input/validate/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "Array of contact records to validate. Each item must include email and phone. Text is optional. Min: 1, Max: 50.",
                    "example":
                      '[{"email":"alice@example.com","phone":"+14155550001"},{"email":"bob@example.com","phone":"+14155550002"}]',
                  },
                },
                "required": [
                  "items",
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "List of validation results, one per input item. Preserves the original submission order via the index field.",
                        },
                        "results[].index": {
                          "type": "integer",
                          "description":
                            "Zero-based position of the item in the original request array.",
                        },
                        "results[].email": {
                          "type": "object",
                          "description":
                            "Email validation result. Null when email was not provided for this item.",
                        },
                        "results[].email.valid": {
                          "type": "boolean",
                          "description":
                            "True when the email passes syntax and MX validation.",
                        },
                        "results[].email.normalized": {
                          "type": "string",
                          "description":
                            "Normalized form of the email address. Null when syntax is invalid.",
                        },
                        "results[].email.quality_score": {
                          "type": "number",
                          "description":
                            "Email quality score from 0.0 to 1.0. Penalized by invalidity, disposable domain, and suggestions.",
                        },
                        "results[].email.disposable": {
                          "type": "boolean",
                          "description":
                            "True when the email domain is a known disposable or temporary provider.",
                        },
                        "results[].phone": {
                          "type": "object",
                          "description":
                            "Phone validation result. Null when phone was not provided for this item.",
                        },
                        "results[].phone.valid": {
                          "type": "boolean",
                          "description":
                            "True when the phone number is valid and dialable.",
                        },
                        "results[].phone.normalized": {
                          "type": "string",
                          "description":
                            "Normalized phone number in international format. Null when the number is invalid.",
                        },
                        "results[].phone.quality_score": {
                          "type": "number",
                          "description":
                            "Phone quality score from 0.0 to 1.0. Penalized by invalidity, VoIP, virtual, landline, and unknown type.",
                        },
                        "results[].text": {
                          "type": "object",
                          "description":
                            "Text analysis result. Null when text was not provided for this item.",
                        },
                        "results[].overall_quality_score": {
                          "type": "number",
                          "description":
                            "Weighted quality score from 0.0 to 1.0 combining email and phone fields only. Weights are email 0.5 and phone 0.4, adjusted proportionally when one field is absent. Text does not currently contribute to this score — scoring will be enabled once toxicity_score is available from the sentiment service. Returns 0.0 when only text is provided.",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Error message when this item could not be processed due to an unexpected failure, such as a service timeout or malformed input. Null when the item was processed successfully, regardless of whether the fields passed validation or not.",
                        },
                        "total": {
                          "type": "integer",
                        ...
                        "valid_count": {
                          "type": "integer",
                          "description":
                            "Number of items where all provided fields have valid set to true.",
                        },
                        "invalid_count": {
                          "type": "integer",
                          "description":
                            "Number of items where at least one provided field has valid set to false, or where processing failed due to a timeout or unexpected error.",
                        },
                        "average_quality_score": {
                          "type": "number",
                          "description":
                            "Average of overall_quality_score across all successfully processed items. Items that failed due to a timeout or unexpected error are excluded from this average.",
                        },
                      },
                    },
                    "metadata": {
    ...
    "/v1/systems/input/validate": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "email": {
                    "type": "string",
                    "description":
                      "The email address to validate. At least one of email, phone, or text must be provided.",
                    "example": "user@example.com",
                  },
                  "phone": {
                    "type": "string",
                    "description":
                      "The phone number to validate. Must include country code in E.164 format. At least one of email, phone, or text must be provided.",
                    "example": "+12015551234",
                  },
                  "text": {
                    "type": "string",
                    "description":
                      "The text content to analyze for profanity, toxicity, and sentiment. At least one of email, phone, or text must be provided.",
                    "example":
                      "I just wanted to say that your customer service team was incredibly helpful and resolved my issue faster than expected.",
                  },
                },
                "example": {
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "email": {
                          "type": "object",
                          "description":
                            "Email validation result. Null when email was not provided.",
                        },
                        "email.valid": {
                          "type": "boolean",
                          "description":
                        ...
                        "email.original": {
                          "type": "string",
                          "description":
                            "The original email address as provided in the request.",
                        },
                        "email.syntax_valid": {
                          "type": "boolean",
                          "description":
                            "True when the email address has a valid structure.",
                        },
                        "email.mx_valid": {
                          "type": "boolean",
                          "description":
                            "True when the email domain has valid MX records.",
                        },
                        "email.disposable": {
                          "type": "boolean",
                          "description":
                        ...
                        "email.suggestion": {
                          "type": "string",
                          "description":
                            "Suggested correction when a typo is detected in the domain (e.g. gmial.com → gmail.com). Null otherwise.",
                        },
                        "email.flags": {
                          "type": "string",
                          "description":
                            "Triggered flags. Possible values: email_syntax_invalid, email_mx_invalid, email_disposable, email_has_suggestion.",
                        },
                        "email.quality_score": {
                          "type": "number",
                          "description":
                        ...
                        "phone": {
                          "type": "object",
                          "description":
                            "Phone validation result. Null when phone was not provided.",
                        },
                        "phone.valid": {
                          "type": "boolean",
                          "description":
                        ...
                        "phone.country": {
                          "type": "string",
                          "description":
                            "ISO 3166-1 alpha-2 country code detected from the number (e.g. US, CO). Null when the number is invalid.",
                        },
                        "phone.type": {
                          "type": "string",
                          "description":
                            "Line type. Null when the number is invalid. Possible values: mobile, landline, voip, toll_free, unknown.",
                        },
                        "phone.carrier": {
                          "type": "object",
                          "description":
                            "Carrier information. Null when not available.",
                        },
                        "phone.carrier.name": {
                          "type": "string",
                          "description":
                            "Name of the carrier or operator associated with the number.",
                        },
                        "phone.risk": {
                          "type": "object",
                          "description":
                            "Risk signals associated with the phone number. Null when the validator could not determine risk information.",
                        },
                        "phone.risk.is_voip": {
                          "type": "boolean",
                          "description":
                            "True when the number is confirmed as a VoIP line. False when explicitly confirmed as non-VoIP.",
                        },
                        "phone.risk.is_virtual": {
                          "type": "boolean",
                          "description":
                            "True when the number is confirmed as a virtual number. False when explicitly confirmed as non-virtual.",
                        },
                        "phone.flags": {
                          "type": "string",
                          "description":
                            "Triggered flags. Possible values: phone_invalid, phone_voip, phone_virtual, phone_unknown_type, phone_landline.",
                        },
                        "phone.quality_score": {
                          "type": "number",
                          "description":
                        ...
                        "text": {
                          "type": "object",
                          "description":
                            "Text analysis result. Null when text was not provided.",
                        },
                        "text.is_safe": {
                          "type": "boolean",
                          "description":
                            "False when any moderation flag is triggered. True otherwise.",
                        },
                        "text.toxicity_score": {
                          "type": "number",
                          "description":
                        ...
                        "text.flags": {
                          "type": "string",
                          "description":
                            "Triggered moderation flags. Possible values: text_profanity.",
                        },
          ...
          "422": {
            "description":
              "All fields (email, phone, text) are absent or empty. At least one must be provided.",
          },
        },
      },
    },
    "/v1/systems/content/moderate": {
      "post": {
    ...
    "/v1/systems/text/normalize": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "operations": {
                    "type": "string",
                    "description":
                      "Ordered list of normalization operations to apply. At least one required. Valid values: trim, lowercase, uppercase, normalize_unicode, collapse_whitespace, strip_html, remove_punctuation",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "normalized": {
                          "type": "string",
                          "description":
                            "The text after all operations have been applied in order",
                        },
                        "operations": {
                          "type": "string",
                          "description":
                            "The operations list echoed from the request",
                        },
                      },
                    },
                    "metadata": {
          ...
          "422": {
            "description":
              "text is empty or operations array is empty or missing",
          },
        },
      },
    },
    "/v1/systems/domain/trust/{domain}": {
      "get": {
        ...
        "responses": {
          ...
          "400": {
            "description":
              "Invalid or malformed domain value in the request path.",
          },
        },
      },
    },
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "definitions": {
                          "type": "string",
                          "description":
                            "One or more definitions for the word, each with part_of_speech, definition, and an optional example",
                        },
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "List of words to look up in batch (max 50 items)",
                  },
                },
                "required": [
                  "items",
    ...
    "/v1/health/exercises/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "ids": {
                    "type": "string",
                    "description":
                      "Array of numeric exercise IDs to fetch. Must contain between 1 and 50 items. Each ID must be a positive integer.",
                    "example": "[1, 7, 42]",
                  },
                },
                "required": [
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "Exercises found for the given IDs, in input order. IDs not found are omitted.",
                        },
                        "results[].id": {
                          "type": "integer",
                          "description": "Unique exercise identifier",
                        ...
                        "results[].target_muscles": {
                          "type": "string",
                          "description": "Primary muscles targeted",
                        },
                        "results[].secondary_muscles": {
                          "type": "string",
                          "description": "Secondary muscles engaged",
                        },
                        ...
                        "total": {
                          "type": "integer",
                          "description": "Number of exercises returned",
                        },
                      },
                    },
                    "metadata": {
          ...
          "400": {
            "description": "The request body is missing or not valid JSON.",
          },
          "422": {
            "description":
              "The ids array is empty, exceeds 50 items, or contains a non-positive integer.",
          },
        },
      },
    },
    ...
    "/v1/places/geocode/batch": {
      "post": {
        ...
        "description":
          "Convert up to 20 addresses to coordinates in a single request. Processed concurrently; results are returned in input order. Per-item errors are reported inline. Cache hits avoid outbound network calls.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "addresses": {
                    "type": "string",
                    "description":
                      "List of addresses to geocode (1–20 items, each non-empty). Max 20 due to Nominatim usage policy.",
                  },
                },
                "required": [
                  "addresses",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].address": {
                          "type": "string",
                          "description":
                            "The original address as provided in the request.",
                        },
                        "results[].result": {
                          "type": "object",
                          "description":
                            "Geocoding result (omitted on error). Same fields as the single-item endpoint.",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Error message if geocoding failed (omitted on success).",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of items processed.",
                    ...
                    "results": [
                      {
                        ...
                        "result": {
                          "address":
                            "White House, 1600, Pennsylvania Avenue Northwest...",
                          "city": "Washington",
                          "country": "US",
                          "lat": 38.8977,
                          "lon": -77.0365,
                      ...
                      },
                      {
                        ...
                        "result": {
                          "address":
                            "Tour Eiffel, 5, Avenue Anatole France, Paris...",
                          "city": "Paris",
                          "country": "FR",
                          "lat": 48.8584,
                          "lon": 2.2945,
          ...
          "422": {
            "description":
              "The addresses array is missing, empty, or exceeds 20 items.",
          },
        },
      },
    },
    "/v1/places/reverse-geocode/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "List of coordinate pairs to reverse-geocode (1–20 items). Max 20 due to Nominatim usage policy.",
                  },
                  "items[].lat": {
                    "type": "number",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].result": {
                          "type": "object",
                          "description":
                            "Reverse geocoding result (omitted on error). Same fields as the single-item endpoint.",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Error message if reverse geocoding failed (omitted on success).",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of items processed.",
          ...
          "422": {
            "description":
              "The items array is missing, empty, or exceeds 20 items.",
          },
        },
      },
    },
    "/v1/systems/location/resolve": {
      "post": {
        ...
        "responses": {
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        ...
                        "coordinates": {
                          "type": "object",
                          "description": "Resolved lat/lng coordinates",
                        },
                        "timezone": {
                          "type": "string",
                          "description":
          ...
          "422": {
            "description":
              "Neither address nor coordinates was provided; Geocoding service was unavailable",
          },
        },
      },
    },
    "/v1/systems/timezone/from-ip/{ip}": {
      "get": {
        ...
        "responses": {
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        "ip": {
                          "type": "string",
                          "description": "The IP address as provided",
                        },
                        "city": {
                          "type": "string",
                        ...
                        "timezone": {
                          "type": "string",
                          "description":
                            "IANA timezone identifier. Null when timezone resolution fails.",
                        },
                        "utc_offset": {
                          "type": "string",
                          "description":
                            "UTC offset string. Null when timezone resolution fails.",
                        },
                        "dst_active": {
                          "type": "boolean",
                          "description":
                            "True when daylight saving time is currently active. Null when timezone resolution fails.",
                        },
                        "current_time": {
                          "type": "string",
                          "description": "Current local time in RFC3339 format",
                        },
                      },
                    },
                    "metadata": {
          ...
          "422": {
            "description": "The IP address could not be geolocated",
          },
        },
      },
    },
    "/v1/systems/business-calendar/{country}": {
      "get": {
        ...
        "responses": {
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        ...
                        "year": {
                          "type": "integer",
                          "description": "Year the calendar covers",
                        },
                        "month": {
                          "type": "integer",
                          "description":
          ...
          "422": {
            "description":
              "Country is not a 2-letter ISO code, or year/month is out of the valid range",
          },
        },
      },
    },
    ...
    "/v1/entertainment/horoscope/batch": {
      "post": {
        ...
        "responses": {
          ...
          "422": {
            "description":
              "The signs array is missing, empty, or contains more than 12 items, or includes unsupported sign values.",
          },
        },
      },
    },
    ...
    "/v1/systems/risk/score": {
      "post": {
        ...
        "responses": {
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        "risk_score": {
                          "type": "number",
                          "description": "Composite risk score from 0.0 to 1.0",
                        },
                        "is_safe": {
                          "type": "boolean",
                          "description":
                        ...
                        "flags": {
                          "type": "string",
                          "description": "Array of triggered risk flags",
                        },
                      },
                    },
                    "metadata": {
          ...
          "422": {
            "description": "All of email, phone, and ip_address were omitted",
          },
        },
      },
    },
    "/v1/systems/user/verify": {
      "post": {
        "summary": "Verify User",
        "tags": [
          "identity-risk",
        ...
        "responses": {
          ...
          "422": {
            "description": "email field is missing or empty",
          },
        },
      },
    },
    ...
    "/v1/networking/ip/asn/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "ips": {
                    "type": "string",
                    "description":
                      "List of IP addresses to look up (1–50 items, each must be a valid IPv4 or IPv6 address).",
                  },
                },
                "required": [
                  "ips",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].result": {
                          "type": "object",
                          "description":
                            "ASN data (omitted on error). Same fields as the single-item endpoint.",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Error message if the lookup failed (omitted on success).",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of items processed.",
          ...
          "422": {
            "description":
              "The ips array is missing, empty, exceeds 50 items, or contains an invalid IP address.",
          },
        },
      },
    },
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].result": {
                          "type": "object",
                          "description":
                            "Geolocation data (omitted on error). Same fields as the single-item endpoint.",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
    ...
    "/v1/text/lorem/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "Array of text generation requests. Minimum 1 item, maximum 50 items.",
                  },
                  "items[].paragraphs": {
                    "type": "integer",
                    "description": "Number of paragraphs to generate (1-20)",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "data[].data": {
                          "type": "object",
                          "description":
                            "Contains the generated text if the specific item was successful",
                        },
                        "data[].error": {
                          "type": "string",
                          "description":
                            "Error message if the specific item failed to generate",
                        },
                      },
                    },
                    "metadata": {
          ...
          "422": {
            "description":
              "The request body is malformed, missing the items array, or exceeds the maximum batch size of 50 items.",
          },
        },
      },
    },
    "/v1/technology/markdown/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "markdowns": {
                    "type": "string",
                    "description":
                      "Array of Markdown strings. Min: 1, Max: 50.",
                    "example": '["# Hello", "**bold**", "- item one"]',
                  },
                  "sanitize": {
                    "type": "boolean",
                    "description":
                      "When true, sanitizes HTML output to remove unsafe tags and attributes.",
                  },
                },
                "required": [
                  "markdowns",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "One HTML result per Markdown input, preserving input order",
                        },
                        "results[].html": {
                          "type": "string",
                          "description":
                            "Rendered HTML output for each Markdown string",
                        },
                      },
                    },
                    "metadata": {
          ...
          "422": {
            "description":
              "Body is invalid: empty array, more than 50 items, or invalid Markdown entry.",
          },
          "500": {
            "description": "Unexpected server error.",
          },
              ...
              "schema": {
                ...
                "properties": {
                  "mortgages": {
                    "type": "string",
                    "description":
                      "Array of mortgages to calculate (min: 1, max: 50).",
                    "example":
                      '[{"principal":150000,"rate":6.5,"years":10},{"principal":250000,"rate":5.2,"years":30}]',
                  },
                },
                "required": [
                  "mortgages",
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "Mortgage calculation result for each mortgage request in the same order as the input. Each item has the same fields as the single mortgage endpoint.",
                        },
                        "total": {
                          "type": "integer",
                          "description":
              ...
              "schema": {
                ...
                "properties": {
                  "domains": {
                    "type": "string",
                    "description":
                      "Array of domains to lookup (min: 1, max: 50).",
    ...
    "/v1/technology/base/batch": {
      "post": {
        "summary": "Batch Convert Base",
        "tags": [
          "number-base-conversion",
        ],
        "security": [
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description": "List of conversion requests (1–50 items).",
                  },
                  "items[].from": {
                    "type": "integer",
                    "description": "Source base (2, 8, 10, or 16).",
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].from": {
                          "type": "integer",
                          "description": "The source base used for conversion.",
                        },
                        "results[].to": {
                          "type": "integer",
                          "description": "The target base used for conversion.",
                        },
                        "results[].input": {
                          "type": "string",
                          "description":
    ...
    "/v1/technology/password/batch": {
      "post": {
        "summary": "Batch Generate Passwords",
        "tags": [
          "password-generator",
        ],
        "security": [
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "List of password generation requests (1–50 items).",
                  },
                  "items[].length": {
                    "type": "integer",
                    "description":
                      "Password length (8–128). Defaults to 16 when omitted.",
                  },
                  "items[].uppercase": {
                    "type": "boolean",
                    "description":
                      "Include uppercase letters (A–Z). Defaults to false.",
                  },
                  "items[].numbers": {
                    "type": "boolean",
                    "description": "Include numbers (0–9). Defaults to false.",
                  },
                  "items[].symbols": {
                    "type": "boolean",
                    "description":
                      "Include special characters. Defaults to false.",
                  },
                },
                "required": [
                  "items",
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].result.password": {
                          "type": "string",
                          "description":
                            "The generated password (omitted on error).",
                        },
                        "results[].result.length": {
                          "type": "integer",
                          "description": "Length of the generated password.",
                        },
                        "results[].result.strength": {
                          "type": "string",
                          "description":
                            "Strength assessment (weak, medium, or strong).",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Error message if generation failed (omitted on success).",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of items processed.",
    ...
    "/v1/systems/payment/validate": {
      "post": {
        ...
        "responses": {
          ...
          "422": {
            "description":
              "All of bin, iban, and swift were omitted. At least one is required.",
          },
        },
      },
    },
    "/v1/systems/transaction/risk": {
      "post": {
        ...
        "responses": {
          ...
          "422": {
            "description":
              "ip_address is not a valid IPv4 or IPv6 address, or card_bin is missing",
          },
        },
      },
    },
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description": "List of postal code lookups (1–50 items).",
                  },
                  "items[].code": {
                    "type": "string",
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].code": {
                          "type": "string",
                          "description":
                            "The postal code as provided in the request.",
                        },
                        "results[].country": {
                          "type": "string",
                          "description":
                            "The country code used for the lookup (defaulted to US when omitted).",
                        },
                        "results[].found": {
                          "type": "boolean",
                          "description":
                            "Whether the postal code was found in the dataset.",
                        },
                        "results[].result": {
                          "type": "object",
                          "description":
                            "Postal code details (omitted when found is false).",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of items processed.",
              ...
              "schema": {
                ...
                "properties": {
                  "texts": {
                    "type": "string",
                    "description":
                      "List of texts to check (1–50 items, each non-empty).",
                  },
                },
                "required": [
                  "texts",
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].result.has_profanity": {
                          "type": "boolean",
                          "description": "Whether any profanity was detected.",
                        },
                        "results[].result.censored": {
                          "type": "string",
                          "description":
                            "Text with profane words replaced by asterisks.",
                        },
                        "results[].result.flagged_words": {
                          "type": "string",
                          "description":
                            "Deduplicated list of detected profane words (lowercase).",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of items processed.",
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "List of QR generation requests (1–50 items).",
                  },
                  "items[].data": {
                    "type": "string",
                  ...
                  "items[].size": {
                    "type": "integer",
                    "description":
                      "Image size in pixels (50–1000). Defaults to 256.",
                  },
                  "items[].recovery": {
                    "type": "string",
                    "description":
                      "Error-correction level: low, medium, high, highest. Defaults to medium.",
                  },
                },
                "required": [
                  "items",
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].data": {
                          "type": "string",
                          "description":
                            "The input text or URL that was encoded.",
                        },
                        "results[].image": {
                          "type": "string",
                          "description":
                            "Base64-encoded PNG image data (omitted on error).",
                        },
                        "results[].width": {
                          "type": "integer",
                          "description":
                            "Width of the generated image in pixels (omitted on error).",
                        },
                        "results[].height": {
                          "type": "integer",
                          "description":
                            "Height of the generated image in pixels (omitted on error).",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
    ...
    "/v1/entertainment/quotes/random/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "count": {
                    "type": "integer",
                    "description":
                      "Number of random quotes to return. Between 1 and 50.",
                    "example": "5",
                  },
                },
                "required": [
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "Array of random quotes, one per requested count.",
                        },
                        "results[].id": {
                          "type": "integer",
                          "description": "Unique identifier for the quote.",
                        ...
                        "results[].author": {
                          "type": "string",
                          "description":
                            "Name of the person who said or wrote the quote. May be empty.",
                        },
                        "total": {
                          "type": "integer",
                          "description":
                            "Total number of quotes returned. Always equals the requested count.",
                        },
                      },
                    },
                    "metadata": {
          ...
          "422": {
            "description": "count is missing, less than 1, or greater than 50.",
          },
        },
      },
    },
    ...
    "/v1/technology/random-user/batch": {
      "post": {
              ...
              "schema": {
                ...
                "properties": {
                  "count": {
                    "type": "integer",
                    "description":
                      "Number of users to generate (min: 1, max: 50).",
                    "example": 2,
                  },
                },
                "required": [
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "Ordered list of generated user profiles. Same fields as the single-user endpoint.",
                        },
                        "total": {
                          "type": "integer",
                          "description":
                            "Number of users returned. Matches the requested count.",
                        },
                      },
                    },
                    "metadata": {
                  ...
                  "data": {
                    "results": [
                      ...
                      },
                      {
                        ...
                        "avatar":
                          "https://api.dicebear.com/9.x/identicon/svg?seed=John+Smith",
                      },
                    ],
                    "total": 2,
                  },
          ...
          "400": {
            "description": "Request body is malformed or not valid JSON",
          },
          "422": {
            "description": "count is missing, less than 1, or greater than 50",
          },
              ...
              "schema": {
                ...
                "properties": {
                  "texts": {
                    ...
                    "example":
                      '["I love this!", "This is terrible.", "The table is there."]',
                  },
                },
                "required": [
                  "texts",
                  ...
                  "properties": {
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].breakdown.positive": {
                          "type": "number",
                          "description":
                            "Proportional score for positive sentiment (sums to 1.0 with other classes)",
                        },
                        "results[].breakdown.negative": {
                          "type": "number",
                          "description":
                            "Proportional score for negative sentiment (sums to 1.0 with other classes)",
                        },
                        "results[].breakdown.neutral": {
                          "type": "number",
                          "description":
                            "Proportional score for neutral sentiment (sums to 1.0 with other classes)",
                        },
                    ...
                    "data": {
                      ...
                      "properties": {
                        "corrected": {
                          "type": "string",
                          "description":
                            "The full input text with all misspelled words replaced by the top-ranked suggestion",
                        },
                        "corrections": {
                          "type": "string",
                          "description":
                            "List of individual corrections. Each item contains: original (the misspelled word), suggested (the top-ranked replacement applied to corrected), suggestions (up to 3 ranked alternatives returned by LanguageTool, from most to least likely), and position (0-based Unicode character offset in the original text)",
                        },
                      },
                    },
                    "metadata": {
              ...
              "schema": {
                ...
                "properties": {
                  "texts": {
                    "type": "string",
                    "description":
                      "The list of texts to spell-check. Between 1 and 50 items.",
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "One entry per input text, in the same order as the input array. Each item contains corrected (the fixed text) and corrections (list of individual corrections with original, suggested, suggestions, and position).",
                        },
                        "total": {
                          "type": "integer",
                          "description":
                            "Number of texts processed. Equals the length of the input array.",
                        },
                      },
                    },
                    "metadata": {
              ...
              "schema": {
                ...
                "properties": {
                  "items": {
                    "type": "string",
                    "description":
                      "List of timezone lookup requests (1–50 items).",
                  },
                  "items[].timezone": {
                    "type": "string",
                    "description":
                      "IANA timezone name (e.g. 'America/New_York'). Highest priority.",
                  },
                  "items[].city": {
                    "type": "string",
                    "description":
                      "City name for city-based lookup. Used when timezone is not set.",
                  },
                  "items[].lat": {
                    "type": "number",
                    "description":
                      "Latitude (-90 to 90). Used when neither timezone nor city is set.",
                  },
                  "items[].lon": {
                    "type": "number",
                    "description":
                      "Longitude (-180 to 180). Used alongside lat for coordinate-based lookup.",
                  },
                },
                "required": [
                  "items",
                    ...
                    "data": {
                      ...
                      "properties": {
                        ...
                        "results[].info.offset": {
                          "type": "string",
                          "description":
                            "UTC offset in +HH:MM or -HH:MM format.",
                        },
                        "results[].info.current_time": {
                          "type": "string",
                          "description": "Current time in UTC (RFC 3339).",
                        },
                        "results[].info.is_dst": {
                          "type": "boolean",
                          "description":
                    ...
                    "results": [
                      {
                        "info": {
                          "timezone": "America/New_York",
                          "offset": "-05:00",
                          "current_time": "2026-01-01T09:00:00Z",
                          "is_dst": false,
                        },
                      },
                      {
                        "info": {
                          "timezone": "Asia/Tokyo",
                          "offset": "+09:00",
                          "current_time": "2026-01-01T23:00:00Z",
                          "is_dst": false,
                        },
                      },
                      {
                        "info": {
                          "timezone": "Europe/London",
                          "offset": "+00:00",
                          "current_time": "2026-01-01T14:00:00Z",
                          "is_dst": false,
                        },
                      },
                    ],
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "List of trivia questions returned in the same order as the input filters.",
                        },
                        "results[].category": {
                          "type": "string",
                          "description":
                            "The topic filter used to retrieve the trivia question.",
                        },
                        "results[].difficulty": {
                          "type": "string",
                          "description":
                            "The complexity level filter used to retrieve the trivia question.",
                        },
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Describes why the question could not be retrieved for this filter. Omitted if the query was successful.",
                        },
                        "results[].data": {
                          "type": "object",
                          "description":
                            "The trivia question returned for this filter. Empty if the query failed.",
                        },
                        ...
                        "results[].data.category": {
                          "type": "string",
                          "description":
                            "The category the trivia question belongs to.",
                        },
                        ...
                        "total": {
                          "type": "integer",
                          "description":
                            "Total number of trivia results returned.",
                        },
                      },
                    },
                    "metadata": {
    ...
    "/v1/technology/convert/batch": {
      "post": {
        "summary": "Batch Convert Units",
        "tags": [
          "unit-conversion",
        ],
        "security": [
              ...
              "schema": {
                ...
                "properties": {
                  "operations": {
                    "type": "string",
                    "description":
                      "Array of operations to convert (min: 1, max: 50).",
                    "example":
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "List of unit conversion results returned in the same order as the input operations.",
                        },
                        "results[].from": {
                          "type": "string",
                        ...
                        "results[].error": {
                          "type": "string",
                          "description":
                            "Error message if the conversion failed. Empty when success is true.",
                        },
                        "results[].data": {
                          "type": "object",
                          "description":
                            "Conversion result details. Contains empty values when the conversion fails.",
                        },
                        "results[].data.from": {
                          "type": "string",
                        ...
                        "results[].data.input": {
                          "type": "number",
                          "description":
                            "Original numeric value provided for conversion.",
                        },
                        "results[].data.result": {
                          "type": "number",
                        ...
                        "results[].data.formula": {
                          "type": "string",
                          "description":
                            "Formula or conversion factor used to calculate the result.",
                        },
                        "total": {
                          "type": "integer",
                          "description":
                            "Total number of conversion results returned.",
                        },
                      },
                    },
                    "metadata": {
              ...
              "schema": {
                ...
                "properties": {
                  "user_agents": {
                    "type": "string",
                    "description":
                      "Array of user agents to parse (min: 1, max: 50).",
                    "example":
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "List of parsed user agents results returned in the same order as the input user agents.",
                        },
                        "results[].user_agent": {
                          "type": "string",
                          "description":
                            "The original user agent string from the input.",
                        },
                        "results[].data": {
                          "type": "object",
                          "description": "Parsed user agent details.",
                        },
                        "results[].data.browser": {
                          "type": "string",
                          "description":
                            "Detected browser name (e.g. Chrome, Firefox, Safari, Edge, Opera, Internet Explorer, Other). Empty if not detected.",
                        },
                        "results[].data.browser_version": {
                          "type": "string",
                          "description":
                            "Detected browser version (major.minor). Empty if not detected.",
                        },
                        "results[].data.os": {
                          "type": "string",
                          "description":
                            "Detected operating system (e.g. Windows, macOS, Linux, Android, iOS, ChromeOS, Other). Empty if not detected.",
                        },
                        "results[].data.os_version": {
                          "type": "string",
                          "description":
                            "Detected OS version (format varies by platform). Empty if not detected.",
                        },
                        "results[].data.device": {
                          "type": "string",
                          "description":
                        ...
                        "total": {
                          "type": "integer",
                          "description":
                            "Total number of parsed user agent results returned.",
                        },
                      },
                    },
                    "metadata": {
    ...
    "/v1/networking/whois/batch": {
      "post": {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "domains": {
                    "type": "string",
                    "description": "Array of domain names. Min: 1, Max: 50.",
        ...
        "responses": {
                    ...
                    "data": {
                      ...
                      "properties": {
                        "results": {
                          "type": "string",
                          "description":
                            "One entry per domain, in the same order as the input",
                        },
                        "results[].domain": {
                          "type": "string",
                          "description": "Domain name requested in the batch",
                        },
                        "results[].found": {
                          "type": "boolean",
                          "description":
                            "False when WHOIS data could not be found",
                        },
                        "results[].error": {
                          "type": "string",
                          "description": "Error message when found is false",
                        },
                        "results[].data": {
                          "type": "object",
                          "description":
                            "WHOIS information for the domain when found is true",
                        },
                        "total": {
                          "type": "integer",
                          "description": "Total number of results returned",
          ...
          "422": {
            "description":
              "Invalid request body. This includes empty arrays, more than 50 domains, invalid domain names, or malformed payloads.",
          },
          "500": {
            "description": "Unexpected server error during batch WHOIS lookup.",
          },
        },
      },
    },
